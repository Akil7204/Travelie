...
const TripPage: React.FC = () => {
  return (
    ...
    <div className="max-w-5xl mx-auto p-6">
      ...
      <div className="mt-8">
        <h1 className="text-4xl font-bold text-blue-600 capitalize">Varkala</h1>
      ...
      <div className="mt-6">
        ...
        <p className="text-gray-700 mt-2">
          Varkala Beach, also known as Papanasam Beach, is situated in the town
          of Varkala. It’s part of the Indian Ocean and known for its cliffs and
          serene beauty.
        </p>
      </div>
